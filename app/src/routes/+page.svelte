...
<div class="flex flex-row justify-center gap-4 p-4 font-serif font-bold text-slate-100">
...
<div class="flex flex-col items-center justify-center gap-2 p-8">
	...
	<em class="text-xs"
		>Move the slider to compare a layover of medieval London over modern London.</em
	>
	...
	<p class="font-bold">London Bridge</p>
	<em class="text-xs"
		>Click the image to preview what you would see if you opened the app at this location and
		pointed your phone at London Bridge.</em
	>
	<button
